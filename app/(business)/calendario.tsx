...
// una vista semana/mes futura solo necesita calcular otro rango y llamar a
// esta misma función. Igual que en disponibilidad.tsx/confirmacion.tsx: sin
// joins embebidos de PostgREST (`Relationships: []` en types/database.ts),
// así que son 3 queries secuenciales/paralelas + merge en JS.
